...
export default function Constructor() {
  ...
  const summaryStats = useMemo(() => [
    ...
    },
    {
      ...
      value: 3,
      description: 'Дашборды, анализ связей и автоматический отчёт',
  ...
  const helperCards = useMemo(() => [
    ...
    },
    {
      ...
      description: 'Переключитесь в режим анализа связей, чтобы увидеть зависимости между объектами данных.',
    },
    {
